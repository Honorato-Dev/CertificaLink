  ...
  return (
    <Layout title=''>
      ...
      <div className='  bg-white bg-opacity-80 mt-8 mb-8 rounded-md'>
        <Link className="text-indigo600 font-semibold flex py-3 px-3" href="/services">
        <span className='py-1 px-1 '><BiArrowBack/></span>
        Voltar
      </Link>
    
        <div className='flex justify-center py-6'>
        <h1 className="text-3xl font-semibold"><span className='  rounded-full p-2 '>{certifical.name}</span></h1>
      </div>
        ...
        <div className='grid  md:grid-cols-1 md:gap-1'>
          ...
          <div className='px-3 py-3'>
            ...
            <p className='text-3xl font-semibold   p-2'>### <span className='text-3xl font-semibold '>{certifical.price}</span></p>
            </div>
          <p className='pt-6 flex  font-semibold'>Clique no ícone para contato <span className='py-1 px-2'><BsArrowDownLeft/></span></p>
        <div className='flex '>
        <button onClick={redirecionarWhatsapp} className=' bg-greenzap p-3 mb-4 rounded text-base font-semibold'><BsWhatsapp/></button>
